/*
Prompt the user for a number n. Generate all Armstrong numbers from 0 to n.
 */

import java.util.Scanner;

public class Murdock_Problem5 {
    public static void main(String[] args) {
        ...
        //Get user input
        int userInput;
        System.out.println("Input a number, n. This program will generate all Armstrong numbers from 0 to n.");
        System.out.println("Input an integer:");
        userInput = scnr.nextInt();

        //Creating an array to store numbers that pop positive for being an Armstrong number
